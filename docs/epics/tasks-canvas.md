...
## Tasks tool scaffold: schema, backend routes, and a rendered list
...
## React Flow canvas with draggable, position-persisting cards
...
## Create, edit, and delete tasks from the canvas UI
...
## Canvas polish and empty/error states
